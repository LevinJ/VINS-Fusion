...
//        pub_path.publish(path);
        ...
        ROS_DEBUG("idx = %d, time: %f, t: %f %f %f, vxyz: %f %f %f, ypr: %f %f %f \n", img_idx++, header.stamp, tmp_T.x(), tmp_T.y(), tmp_T.z(),
        		estimator.Vs[WINDOW_SIZE].x(), estimator.Vs[WINDOW_SIZE].y(), estimator.Vs[WINDOW_SIZE].z(), ypr[0],ypr[1],ypr[2]);
    }
}
