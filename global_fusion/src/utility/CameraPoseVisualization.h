...
public:
	...
	void publish_parking_lot(ros::Publisher &marker_pub, double yaw);
	void publish_car(ros::Publisher &pub_car,double t, Eigen::Vector3d t_w_car, Eigen::Quaterniond q_w_car);
private:
